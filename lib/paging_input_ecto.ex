defmodule PagingInputEcto do
  ...
  defstruct page_size: 8, cursor_id: nil, sort_direction: :desc
  ...
  import Ecto.Query, only: [limit: 2, where: 3, order_by: 3]
  ...
  def put_page_size(%__MODULE__{} = paging_input, _args), do: paging_input
